      ...
      <div>
        <div className="flex justify-center">
          <div className="backdrop-blur-sm bg-white/30 p-6 rounded-xl w-[90vw] hover:backdrop-blur-md hover:bg-amber-500/30 transform transition duration-1000">
            <p>
              <span className="text-4xl font-extrabold text-emerald-900">Hey,</span> <br />
              <span className="text-3xl font-bold text-emerald-800 ">{profileData.name || "User"}</span>
            </p>
            {/* Stats Cards */}
                ...
                <div className="flex flex-col justify-center items-center h-52">
                  ...
                  <div className="flex space-x-2 mt-7">
                    ...
                    <div className="text-xl font-delius">
                      <p>
                        <a href="/PlanChoosing">Change Plan???</a>
                      </p>
                    </div>
                  </div>
                </div>
